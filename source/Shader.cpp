...
void Shader::checkCompileErrors(GLuint shader, std::string type)
{
    ...
    if (type != "PROGRAM")
    {
        ...
        if (!success)
        {
            ...
            throw std::runtime_error((std::string)"ERROR SHADER_COMPILATION_ERROR(" + type + "): " + infoLog);
        }
    }
    else
    {
        ...
        if (!success)
        {
            ...
            throw std::runtime_error((std::string)"ERROR PROGRAM_LINKING_ERROR(" + type + "): " + infoLog);
        }
    }
}
